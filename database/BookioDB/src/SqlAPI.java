...
public class SqlAPI {
	...
	public void insertUser(String user_id, String phone_no) {
		//createConnectionAndStatement();
		String query = "insert into User values (\"" + user_id + "\",\"" + phone_no + "\");";
		try {
	...
	public String getBooksOfCourse(String course_no) {
		String query = "select book_name,book_author from CourseBooks natural join Books where course_no=\"" + course_no + "\";";
		String result = "";
		try {
